...
// The point of this file is to take all the reducers in your app and combine them into one reducer. This is because when you create the store in Redux and pass in a reducer, it can take in only one reducer as an argument. See the root index page for the store.
